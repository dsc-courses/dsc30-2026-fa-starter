...
Hi everyone, welcome to the Fall 2026 offering of DSC 30, Data Structures and Algorithms for Data Science! 
...
mkdir dsc30_fa26
cd ./dsc30_fa26
git clone https://github.com/dsc-courses/dsc30-2026-fa-starter.git
```

What you are doing above is creating a new folder called dsc30_fa26 (hence `mkdir dsc30_fa26`), then moving into that directory (`cd = change directory`), and cloning whatever files can be found inside the git repository. 
